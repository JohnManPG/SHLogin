<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ taglib prefix="s" uri="/struts-tags"%>         <!-- 导入strut标签  -->
	...
	<form action="login" method="post" name="myform" >
		<div class="left">
			...
			<div class="line" id="line_name">
				...
				<div class="input">
					<input type="text" name="user.useName" id="name" onblur="v_name();" onkeyup="v_name();" />
					<div class="none"><span></span></div>
				</div>
			</div>
			...
			<div class="line" id="line_repeat">
				...
				<div class="input">
					<input type="password" name="user.password" id="repeat" onblur="v_repeat();" onkeyup="v_repeat();" />
					<div class="none"><span></span></div>
				</div>
			</div>
		</div>
		...
		<div class="right">
			<input type="submit" name="B1" id="submit" value="完成注册" class="submit" disabled="disabled"/>
